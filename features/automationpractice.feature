...
Then I set "email_create" input with "auto10test@test.com" value
...
Then I validate "email" input contains "auto10test@test.com" value
Then I set "passwd" input with "autotest0" value
...
When I click on "Sign in" link
Then I am on "Authentication" page
Then I set "email" input with "auto10test@test.com" value
Then I set "passwd" input with "autotest0" value
